...
/*
    ...
    public void setPublicB(BigInteger publicB) {
        ...
        sharedKeyA = publicB.modPow(secretA,primeValue);//вычисляем секретный ключ
        System.out.println("[На клиенте вычислен общий секрет]");
        System.out.println("[Общий секрет] = " + sharedKeyA);
...
*/
...

    {
        ...
        md.update(String.valueOf(publicA).getBytes());
