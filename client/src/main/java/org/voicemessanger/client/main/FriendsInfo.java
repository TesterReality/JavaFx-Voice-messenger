...
public class FriendsInfo {
    ...
    BufferedImage lastClickAvatar;
    String[] temp;
    private String lastFriendStr = null;
    public FriendsInfo(){}

    public BufferedImage getLastClickAvatar() {
        return lastClickAvatar;
    }

    public void setLastClickAvatar(BufferedImage lastClickAvatar) {
        this.lastClickAvatar = lastClickAvatar;
    }
